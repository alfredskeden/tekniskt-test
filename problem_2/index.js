...
var checkForLinks = function (webpage) { return __awaiter(void 0, void 0, void 0, function () {
    var driver, elements;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, , 4, 6]);
                return [4 /*yield*/, driver.get(webpage)];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                elements.forEach(function (webElement) {
                    webElement.getAttribute('href').then(function (hrefString) {
